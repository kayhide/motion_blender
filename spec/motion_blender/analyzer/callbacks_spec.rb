...
describe MotionBlender::Callbacks do
  use_lib_dir

  let(:analyzer) { MotionBlender::Analyzer.new }

  before do
    MotionBlender::Analyzer::Parser.reset_callbacks :parse
    MotionBlender::Analyzer::Require.reset_callbacks :require
  end
  ...
  describe '.on_parse' do
    ...
    it 'runs given block with parser arg' do
      ...
      expect(parsers).to all be_a MotionBlender::Analyzer::Parser
  ...
  describe '.on_require' do
    ...
    it 'runs given block with require arg' do
      ...
      expect(reqs).to all be_a MotionBlender::Analyzer::Require
